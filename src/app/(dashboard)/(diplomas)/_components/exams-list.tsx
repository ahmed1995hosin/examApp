...
export default function ExamsList({subjectId}:{subjectId:string}) {
    ...
    // useExams
    const {exams,isLoading,error,fetchNextPage,isFetchingNextPage,hasNextPage} = useExams(subjectId);
          ...
          <InfiniteScroll
                   ...
                   >
                       ...
                       {/* Exams list */}
                        ...
                        {/* scroll to view more */}
                            {(!isFetchingNextPage && !isLoading && !error) && (<div className="flex flex-col text-base items-center my-6 font-light text-gray-600">
                            {hasNextPage ? (
                                <>
