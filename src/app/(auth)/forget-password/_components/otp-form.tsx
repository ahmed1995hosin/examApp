...
export default function OtpForm() {
        ...
        const {isPending:isPendingForgetPassword,error:errorForgetPassword,forgetPassword}=useForgetPassword();
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-start mb-10">
                <button className="p-2 border-[1.5px] border-gray-200" onClick={prevStep}>
                    <MoveLeft className="w-6 h-6 text-blue" />
                </button>
            </div>

            {/* heading Verify OTP*/}
                <h2 className="text-gray-800 text-3xl font-bold font-inter  text-left">Verify OTP</h2>
                <p className="text-gray-500  text-base text-left mt-2.5 mb-6">
                   Please enter the 6-digits code we have sent to: <br />
                   user@example.com 
                   <span className="ml-2.5 text-blue-600 underline cursor-pointer" onClick={prevStep}>Edit</span>
                </p>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className=" my-4">
                                    ...
                                    <FormDescription className="text-center font-medium pt-6 text-sm text-gray-500">
                                        ...
                                        {time === 0 && (
                                            ...
                                            <span
                                                ...
                                                isPendingForgetPassword ? "text-gray-400" : "text-blue-600 underline"
                                                }`}
                                                onClick={!isPendingForgetPassword ? resentHandler : void 0}
                                            >
                        ...
                        <div className="flex items-center justify-center py-6">
                           <Button disabled={isPending||(!form.formState.isValid && form.formState.isSubmitted)} type="submit" className="w-full">Verify Code</Button>
                        </div>
                    </form>
                </Form>
        </>
