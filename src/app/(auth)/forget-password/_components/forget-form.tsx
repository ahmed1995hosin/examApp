    ...
    return (
        <>
            {/* heading forget password */}
                <h1 className="text-gray-800 text-3xl font-bold font-inter  text-left">Forgot Password</h1>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Email</FormLabel>
                                        <Input {...field} placeholder="user@example.com" error={Boolean(form.formState.errors.email)}/>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <div className="flex items-center justify-center py-6">
                           <Button disabled={isPending||(!form.formState.isValid && form.formState.isSubmitted)} type="submit" className="w-full">Continue<MoveRight className="ml-2.5" /></Button>
                        </div>
                    </form>
                </Form>
        </>
