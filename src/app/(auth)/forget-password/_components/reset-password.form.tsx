...
export default function ResetPasswordForm() {
    ...
    return (
            ...
            {/* heading create new password */}
                <h1 className="text-gray-800 text-3xl font-bold font-inter  text-left">Create a New Password</h1>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="">
                            ...
                            render={({ field }) => (
                                <FormItem className="mt-4">
                                    <FormLabel>New Password</FormLabel>
                                        <PasswordInput {...field} placeholder="********" error={Boolean(form.formState.errors.password)}/>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                            ...
                            render={({ field }) => (
                                <FormItem className="my-4">
                                    <FormLabel>Confirm Password</FormLabel>
                                        <PasswordInput {...field} placeholder="********" error={Boolean(form.formState.errors.confirmPassword)}/>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <div className="flex items-center justify-center mb-9 mt-9">
                           <Button disabled={isPending || (!form.formState.isValid && form.formState.isSubmitted)} type="submit" className="w-full">Reset Password</Button>
                        </div>
                    </form>
                </Form>
        </>
